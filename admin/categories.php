            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="categories.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-tags"></span><p>Faculty</p></a></li>
                        ...
                        <li><a href="notice.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-th-list"></span><p>Exam Notice</p></a></li>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['name']; ?> ?')" <?php print ' href="pages/drop_ct.php?id='.$row['category_id'].'">Drop Teachers</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Teachers Name" name="category" required autocomplete="off">
                                        </div>
										<div class="form-group">
