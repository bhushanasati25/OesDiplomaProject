...
<head>
        ...
        <title>Oes | Manage Exam Notice</title>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="categories.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-tags"></span><p>Faculty</p></a></li>
                        ...
                        <li class="active"><a href="notice.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-th-list"></span><p>Exam Notice</p></a></li>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Exam Notice</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Add Exam Notice</a></li>
                                            </ul>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Exam Notice Title" name="title" required autocomplete="off">
                                        </div>
