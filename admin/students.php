                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        ...
                                        Nothing was found in database.
										   ...
										   ?>
                                    <form class="m-t-md" action="pages/email.php" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-success btn-block">Send Email</button>
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Enrollment No" name="phone" required autocomplete="off">
                                        </div>
										<div class="form-group">
										...
										<div class="form-group">
                                            <label for="exampleInputEmail1">Select Teachers</label>
