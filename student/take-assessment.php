                ...
                <div id="main-wrapper">
                    <div class="row col-md-12">
						...
						<div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Start Examination</h3>
                                </div>
                                <div class="panel-body">
								<?php
								if ($record_found == "1") {
								...
								print '
                                 <div class="alert alert-success" role="alert">
                                  You are good to go.
									...
									'; ?>
									<a onclick="return confirm('Are you sure you want to begin ?')" class="btn btn-success" href="assessment.php">Start Exam</a>
						...
						<div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Examination History</h3>
                                </div>
                                <div class="panel-body">
                                <?php
								if ($record_found == "1") {
								print '
                                 <div class="alert alert-info" role="alert">
                                  You attend this exam on <strong>'.$take_date.'</strong></strong>
                                    </div>';		
